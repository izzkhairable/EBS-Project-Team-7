...
@app.route("/dashboard")
def dashboard_noroute():
    if len(r.lrange('devices', 0, -1)) > 0:
        return render_template("redirect.html", zone=json.loads(r.lrange('devices',0, -1)[0])['zone'])
    else:
        return render_template('redirect.html', zone="empty")

@app.route("/dashboard/<string:zone>")
def dashboard(zone):
    if len(r.lrange('devices', 0, -1)) > 0:
        zone_list = ''
        ...
        for thing in r.lrange('devices', 0, -1):
            ...
            if curr_zone == zone:
                ...
                if len(r.lrange(curr_thing + "DATACOLLECTION", 0, -1)) > 0:
                    ...
                    total_gyroscopeX_for_current_day = 0
                    total_gyroscopeY_for_current_day = 0
                    total_gyroscopeZ_for_current_day = 0
                    ...
                    total_gyroscopeX_for_current_month = 0
                    total_gyroscopeY_for_current_month = 0
                    total_gyroscopeZ_for_current_month = 0
                    ...
                    for index in range(0, len(dailySensorList)):
                        ...
                        if index > 0 and index < len(dailySensorList)-1: #if we between 2nd to 2nd last item
                            if (eventyear == previouseventdate.year and eventmonth == previouseventdate.month):
                                ...
                                total_gyroscopeX_for_current_month+=jsonobj['gyroscopeX']
                                total_gyroscopeY_for_current_month+=jsonobj['gyroscopeY']
                                total_gyroscopeZ_for_current_month+=jsonobj['gyroscopeZ']
                                ...
                                if eventday == previouseventdate.day:
                                    ...
                                    total_gyroscopeX_for_current_day+=jsonobj['gyroscopeX']
                                    total_gyroscopeY_for_current_day+=jsonobj['gyroscopeY']
                                    total_gyroscopeZ_for_current_day+=jsonobj['gyroscopeZ']


                                    total_no_of_data_for_current_day+=1
                                else:
                                    daily_sensor_list+=json.dumps({"date": str(previouseventdate), "gyroscopeX": total_gyroscopeX_for_current_day/total_no_of_data_for_current_day, "gyroscopeY": total_gyroscopeY_for_current_day/total_no_of_data_for_current_day, "gyroscopeZ": total_gyroscopeZ_for_current_day/total_no_of_data_for_current_day, "ambientTemperature": total_temperature_for_current_day/total_no_of_data_for_current_day, "ambientHumidity": total_humidity_for_current_day/total_no_of_data_for_current_day, "ambientPressure": total_pressure_for_current_day/total_no_of_data_for_current_day, "ambientLight": total_intensity_for_current_day/total_no_of_data_for_current_day}) + '|'
                                    total_temperature_for_current_day = jsonobj['ambientTemperature']
                                    total_humidity_for_current_day = jsonobj['ambientHumidity']
                                    total_pressure_for_current_day = jsonobj['ambientPressure']
                                    total_intensity_for_current_day = jsonobj['ambientLight']
                                ...
                                total_no_of_data_for_current_day = 1
                                monthly_sensor_list+=json.dumps({"date": str(previouseventdate), "gyroscopeX": total_gyroscopeX_for_current_month/total_no_of_data_for_current_month, "gyroscopeY": total_gyroscopeY_for_current_month/total_no_of_data_for_current_month, "gyroscopeZ": total_gyroscopeZ_for_current_month/total_no_of_data_for_current_month, "ambientTemperature": total_temperature_for_current_month/total_no_of_data_for_current_month, "ambientHumidity": total_humidity_for_current_day/total_no_of_data_for_current_month, "ambientPressure": total_pressure_for_current_day/total_no_of_data_for_current_month, "ambientLight": total_intensity_for_current_day/total_no_of_data_for_current_month}) + '|'
                                total_temperature_for_current_month = jsonobj['ambientTemperature']
                                total_humidity_for_current_month = jsonobj['ambientHumidity']
                                total_pressure_for_current_month = jsonobj['ambientPressure']
                                total_intensity_for_current_month = jsonobj['ambientLight']
                            ...
                            if (eventyear == previouseventdate.year and eventmonth == previouseventdate.month):
                                ...
                                total_no_of_data_for_current_month+=1
                                monthly_sensor_list+=json.dumps({"date": str(eventdate), "gyroscopeX": total_gyroscopeX_for_current_month/total_no_of_data_for_current_month, "gyroscopeY": total_gyroscopeY_for_current_month/total_no_of_data_for_current_month, "gyroscopeZ": total_gyroscopeZ_for_current_month/total_no_of_data_for_current_month, "ambientTemperature": total_temperature_for_current_month/total_no_of_data_for_current_month, "ambientHumidity": total_humidity_for_current_day/total_no_of_data_for_current_month, "ambientPressure": total_pressure_for_current_day/total_no_of_data_for_current_month, "ambientLight": total_intensity_for_current_day/total_no_of_data_for_current_month}) + '|'
                                ...
                                if eventday == previouseventdate.day:
                                    ...
                                    total_gyroscopeZ_for_current_day+= jsonobj['gyroscopeZ']
                                    total_no_of_data_for_current_day+=1
                                    daily_sensor_list+=json.dumps({"date": str(eventdate), "gyroscopeX": total_gyroscopeX_for_current_day/total_no_of_data_for_current_day, "gyroscopeY": total_gyroscopeY_for_current_day/total_no_of_data_for_current_day, "gyroscopeZ": total_gyroscopeZ_for_current_day/total_no_of_data_for_current_day, "ambientTemperature": total_temperature_for_current_day/total_no_of_data_for_current_day, "ambientHumidity": total_humidity_for_current_day/total_no_of_data_for_current_day, "ambientPressure": total_pressure_for_current_day/total_no_of_data_for_current_day, "ambientLight": total_intensity_for_current_day/total_no_of_data_for_current_day}) + '|'
                                else:
                                    daily_sensor_list+=json.dumps({"date": str(previouseventdate), "gyroscopeX": total_gyroscopeX_for_current_day/total_no_of_data_for_current_day, "gyroscopeY": total_gyroscopeY_for_current_day/total_no_of_data_for_current_day, "gyroscopeZ": total_gyroscopeZ_for_current_day/total_no_of_data_for_current_day, "ambientTemperature": total_temperature_for_current_day/total_no_of_data_for_current_day, "ambientHumidity": total_humidity_for_current_day/total_no_of_data_for_current_day, "ambientPressure": total_pressure_for_current_day/total_no_of_data_for_current_day, "ambientLight": total_intensity_for_current_day/total_no_of_data_for_current_day}) + '|'
                                    total_temperature_for_current_day = jsonobj['ambientTemperature']
                                    total_humidity_for_current_day = jsonobj['ambientHumidity']
                ...
                if len(r.lrange(curr_thing + 'POPULATION', 0, -1)) > 0:
                    dailyPopulationList = r.lrange(curr_thing + 'POPULATION', 0, -1)[::-1]
